...
public class GameHandler {
    ...
    */
    ...
    public static String dataFileName = "Pon un nombre aquí.csv"; //TODO Construct the autogenerated file name
    public static boolean saveOnDir = true;
    ...
    public static DateFormat filenameF = new SimpleDateFormat("dd-MM-yyyy_HH:mm");
    /**
     * --------------------------------------------------------------------------
     *                              GLOBAL VARIABLES
     * --------------------------------------------------------------------------
    ...
    public static void init(float musicVolume, int env) {
        ...
        GameHandler.sessionUncompletedReps = 0;
